...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($onameError == "" && $contactError == "" && $textError == "" && $tipError == "") {
        ...
        queryMysql("INSERT INTO objects(name, tip, contact, address, time, text) 
            VALUES ('$oname', '$tip', '$contact', '$address', '$wt', '$text')");
        ...
        <div style="width:80%;">
            <form method='post' action='add_object.php' enctype='multipart/form-data'>
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" id="name" name="name" placeholder="Ime objekta...">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="text" id="contact" name="contact" placeholder="Kontakt...">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="text" id="time" name="time" placeholder="Radno vreme objekta...">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="text" id="address" name="address" placeholder="Adresa objekta...">
                    </div>
                </div>
